classdef ExponentaExtender < handle
    ...
    methods
        function obj = ExponentaExtender(root)
            % Init
            if nargin < 1
    ...
    methods (Hidden)
        ...
        function [nname, npath] = cloneclass(obj, classname, sourcedir, prename)
            ...
            obj.txtrep(npath, "obj.ext = ExponentaExtender", "obj.ext = " + obj.getvalidname + "Extender");
            obj.txtrep(npath, "upd = ExponentaUpdater", "upd = " + obj.getvalidname + "Updater");
        end
